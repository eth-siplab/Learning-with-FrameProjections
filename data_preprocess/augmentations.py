...
def _apply_augmentation(x, args):
    if args.dataset in ['ieee_small', 'ieee_big', 'dalia', 'clemson']:
        augmentations = ['perm_jit', 'resample', 'jitter', 'scale', 'shift']
        return _apply_random_augmentation(x, augmentations)
    elif args.dataset in ['ucihar', 'usc', 'hhar']:
        augmentations = ['perm_jit', 'resample', 'jitter', 'scale', 'shift', 'rotation']
        return _apply_random_augmentation(x, augmentations)
    elif args.dataset in ['cpsc', 'chapman']:
        augmentations = ['resample', 'jitter', 'scale', 'shift', 'negate']
        return _apply_random_augmentation(x, augmentations)
